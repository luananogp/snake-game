document.addEventListener ('DOMContentLoaded', () =>{
    ...
    function moveOutcomes(){
        ...
        if (
            ...
            return clearInterval(interval) //this will clear the interval if any of the aboven happen
        }
    ...
    function control (e){
        squares[currentIndex].classList.remove ('snake') // we are moving the class of snake from ALL the squares
        ...
        if (e.keyCode ===39) {
            ...
            direction = -1 //if we press left, the snack will go left one div 
